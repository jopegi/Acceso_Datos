...
public class Animal_Runnable implements Runnable{
    ...
    //En él se define el código a ejecutar por cada nuevo hilo 
    //que se instancie
	@Override
	public void run() {
		...
		//Mensaje que se mostrará al finalizar cada hilo
		System.out.println(nombre+" terminado");
		
	}

	//Método main que lanzará la app
	public static void main (String[] args) {
		...
		//Lanzamos los hilos con el método start() propio de la clase Thread
		//Este método invocará al método run() de cada hilo
		tortuga.start();
		liebre.start();
		guepardo.start();
