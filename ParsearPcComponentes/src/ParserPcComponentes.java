...
public class ParserPcComponentes {
	...
	// Definimos la url de la página web cuyo contenido querenos parsear
	...
	public static void main(String[] args) {
		...
		//Obtenemos el título definido en la etiqueta <title> de la página web
		...
		//Generamos una variable contador que nos servirá para contar el número de elementos impresos por consola
		int contador = 0;

		//Con un bucle for-each recorremos los elementos selecionados
		for (Element e : a) {
			contador++;
			//En cada iteración nos quedamos con las etiquetas <a>
			...
			//Imprimmimos el resultado de cada iteración por consola
			System.out.println("Producto nº: " +contador + " >> " + "Contenido: " + contenido+ " - Precio: " +precio+ "€ " + "\n");
